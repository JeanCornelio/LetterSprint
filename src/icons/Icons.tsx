...
export function HealthiconsAIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      <path
        fill="currentColor"
        d="M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm2 0v14h14V5zm6 2h2a2 2 0 0 1 2 2v8h-2v-4h-2v4H9V9a2 2 0 0 1 2-2m0 2v2h2V9z"
      />
    </svg>
  );
}
  ...
  return (
    <svg
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M8 7v2.4h3.97c-.16 1.03-1.2 3.02-3.97 3.02c-2.39 0-4.34-1.98-4.34-4.42S5.61 3.58 8 3.58c1.36 0 2.27.58 2.79 1.08l1.9-1.83C11.47 1.69 9.89 1 8 1C4.13 1 1 4.13 1 8s3.13 7 7 7c4.04 0 6.72-2.84 6.72-6.84c0-.46-.05-.81-.11-1.16z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function TimeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
      <path
        fill="currentColor"
        d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0m0 469.3c-117.8 0-213.3-95.5-213.3-213.3S138.2 42.7 256 42.7S469.3 138.2 469.3 256S373.8 469.3 256 469.3m21.3-256v-128h-42.7V320l128-128l-32-32z"
      />
    </svg>
  );
}
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="M4 20L20 4m-11.732.732a2.5 2.5 0 1 1-3.536 3.536a2.5 2.5 0 0 1 3.536-3.536m11 11a2.5 2.5 0 1 1-3.536 3.536a2.5 2.5 0 0 1 3.536-3.536"
        color="currentColor"
      />
    </svg>
  );
