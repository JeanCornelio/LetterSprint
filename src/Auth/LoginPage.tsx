  ...
  return (
    <section className=" flex flex-col justify-center items-center gap-10 ">
      <div className="text-center mb-auto">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 mt-8  text-lg lg:text-center lg:text-xl xl:px-60">Challenge yourself by testing your typing speed and accuracy and compete against people from all corners of the globe in real-time to prove your skills and climb to the top of the leaderboard</p>
      </div>
          ...
          <>
            <article className="flex flex-col w-full ">
              ...
              <form className="flex flex-col gap-4 ">
                ...
                <button
                  type="submit"
                  className="bg-sprint-blue text-white p-4 rounded flex items-center justify-center gap-2 font-bold"
                >
            ...
            <div className="flex flex-col w-full gap-4 mb-4 ">
              <button className="border border-1 border-gray-700 p-4 rounded-md  hover:border-sprint-blue transition">
      ...
      {/*  <div className="border border-1 border-gray-700 p-5 rounded-lg ">
