  ...
  return (
    <>
      ...
      <Modal isDismissable isOpen={isOpen} onOpenChange={setOpen}>
        <Dialog className="p-4 md:p-5 rounded-lg flex flex-col min-w-80 gap-3 text-lg font-semibold animate-fade-in bg-sprint-home text-sprint-foreground shadow-xl shadow-black/10 ">
          <button
            className={
